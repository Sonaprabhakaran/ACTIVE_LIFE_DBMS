...
public class ActiveLifeApp {
    ...
    static void showLoginPage() {
        ...
        submitButton.addActionListener(e -> {
            ...
            DBUtil.insertUser(userData.name, Integer.parseInt(userData.age), userData.healthIssues, userData.seriousConditions);
            frame.dispose();
            showHomePage();
        });
